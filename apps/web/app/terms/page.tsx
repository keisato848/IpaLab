                    ...
                    <div className="space-y-8 text-gray-700 leading-relaxed">
                        ...
                        <section>
                            ...
                            <div className="bg-gray-100 p-4 rounded text-sm mb-2">
                                ...
                                <p>
                                    当サービスは現状有姿（AS IS）で提供されるものであり、明示的または黙示的を問わず、その内容の正確性、完全性、有用性、安全性、特定目的への適合性についていかなる保証も行いません。
                                    特に、AIによる採点や解説は誤りを含む可能性があります。
                                    試験の合否結果や、当サービスの利用に起因してユーザーに生じたあらゆる損害（学習機会の損失、データの消失、その他一切の直接的・間接的損害を含む）について、運営者は一切の責任を負いません。
                                </p>
                            </div>
                            <p>
