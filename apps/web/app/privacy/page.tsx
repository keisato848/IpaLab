                    ...
                    <div className="space-y-8 text-gray-700 leading-relaxed">
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2 mb-4">
                                ...
                                <li>
                                    <span className="font-bold">訪問データ:</span> サービスの利用状況を把握するため、ログインの有無にかかわらず、閲覧ページ・訪問日時などのアクセス情報を収集します。訪問者の識別にはブラウザのローカルストレージに保存されるランダムな識別子（UUID）を使用しており、氏名・メールアドレス等の個人を直接特定する情報は含まれません。
                                </li>
                            </ul>
                            <p>
                        ...
                        <section className="bg-red-50 p-6 rounded-md border border-red-200">
                            ...
                            <ul className="list-disc pl-5 space-y-3 text-red-900">
                                ...
                                <li>
                                    ...
                                    当サービスの利用によって生じた、いかなる損害（試験の不合格、学習の遅れ、データの消失、精神的苦痛、その他一切の直接的・間接的損害を含む）についても、運営者は一切の責任を負いません。当サービスは現状有姿（AS IS）で提供されるものであり、明示的または黙示的を問わず、いかなる種類の保証も行いません。すべてのリスクをご理解の上、自己責任でご利用ください。
                                </li>
                                <li>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-800 mb-3 border-l-4 border-blue-500 pl-3">
                                4. アクセス解析およびローカルストレージの利用について
                            </h2>
                            <p className="mb-3">
                                当サービスでは、利用状況の分析やサービスの改善のために、独自のアクセス解析機能を実装しています。
                                この機能では、ブラウザのローカルストレージにランダムな訪問者識別子（UUID）を保存し、
                                閲覧ページや訪問日時などの情報をサーバーに送信・記録します。
                            </p>
                            <p className="mb-3">
                                収集されるデータは統計的な分析にのみ使用され、個人を直接特定するものではありません。
                                ローカルストレージのデータはブラウザの設定から削除することが可能です。
                            </p>
                            <p>
                                また、将来的に Google Analytics 等の外部アクセス解析ツールや Cookie を使用する場合があります。
                            </p>
                        </section>
